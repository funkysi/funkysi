...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	for (var i=0; i<feeds.length; i++){
		...
		var itemdescription=/description/i.test(this.showoptions)? ""+feeds[i].content : /snippet/i.test(this.showoptions)? "<span class=\"snippetfield\">"+feeds[i].contentSnippet+"</span>"  : ""
		rssoutput+=this.itemcontainer + itemtitle + " " + itemlabel + " " + itemdate + "" + itemdescription + this.itemcontainer.replace("<", "</") + ""
	}
